...
<!-- 1. Module config. -->
<script src="https://cdn.jsdelivr.net/gh/randomcontrol/webex-viewer@v1.6.2/webex-viewer-module.js"></script>

<!-- 2. Your app logic. -->
<script src="js/app.js"></script>

<!-- 3. Boot the WASM. -->
<script src="https://cdn.jsdelivr.net/gh/randomcontrol/webex-viewer@v1.6.2/webex-viewer.js"></script>
```
